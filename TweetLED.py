...
while(True):
 ...
 if "ON" in Tweet:
  ...
  # If it did contain the word then print out the tweet along with the message "LED ON"
  print Tweet," - LED ON","\n"
 ...
 if "OFF" in Tweet
  ...
  # If it did contain the word then print out the tweet along with the message "LED OFF"
  print Tweet," - LED OFF","\n"
